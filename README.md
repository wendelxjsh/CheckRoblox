...
ImageButton.Image = "rbxassetid://102990636725805";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("ShinraHub")).Enabled = not (game.CoreGui:FindFirstChild("NoxHub")).Enabled;
end);
...
function Update:Window(Config)
	...
	function uitab:Tab(text, img)
		...
		function main:Line()
			...
			UIGradient.Parent = if (game:GetService("CoreGui")):FindFirstChild("ShinraHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).NoxHub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(100, 100, 100);
